...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, LineChart, Line, Label }
    from 'recharts';
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12} lg={12}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'white' }}>
                                    ...
                                    <h4 style={{ padding: '10px', color: 'grey' }}>Dashboard</h4>
                                </div>
                            </Grid>
                            <Grid item xs={12} md={12} lg={12}>
                                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
                                    <Card sx={{ width: 250, height: 100, margin: 1 }}>
                                        <CardContent sx={{ display: 'flex', justifyContent: 'space-around' }}>
                                            <Typography sx={{ fontSize: 18, fontFamily: 'initial', fontWeight: 'bold', paddingTop: '20px' }} gutterBottom>
                                                AI Text Creation
                                            </Typography>
                                            <IconButton>
                                ...
                                <h3 style={{ padding: '30px', backgroundColor: 'white', margin: '10px', textAlign: 'center' }}>Stay tuned for upcoming features.</h3>
                                <h4 style={{ padding: '10px', backgroundColor: 'white', margin: '10px', marginBottom: '0', borderRadius: '5px', marginTop: '15px' }}>Analytics Overview</h4>
                            </Grid>
